# React Webplatform Templates

This project contains a collection of React components and templates for building various web platform interfaces. Each template is designed to be reusable and customizable to suit different project requirements.

## Installation

To use these templates in your project, simply follow these steps:

1. Clone the repository:

   ```bash
   git clone https://github.com/Alex-Gichau/alex-react-templates.git
   ```

2. Navigate to the desired template directory:

   ```bash
   cd alex-react-templates/<template-name>
   ```
...
## Templates
# React Web Platform Templates

This repository contains a collection of React components for various web platform templates. Each template offers a unique design and functionality suitable for different types of projects.

## Table of Contents

- [Glass Morphism Login Page](#glass-morphism-login-page)
- [CSS Tables with Details](#css-tables-with-details)
- [Button Styles](#button-styles)
- [Scroll Sliders](#scroll-sliders)
- [Swipers Image Sliders](#swipers-image-sliders)
- [Gallery](#gallery)
- [Details Cards](#details-cards)
- [Animated Toolbar](#animated-toolbar)
- [Glow Hover Effect](#glow-hover-effect)
...
- [CSS Page Loaders](#css-page-loaders)
- [Navbars](#navbars)
- [Sidebars](#sidebars)
- [Search Filter](#search-filter)
- [Responsive Layout in CSS](#responsive-layout-in-css)
- [Animated Cursor](#animated-cursor)
- [Hover Effect Colored Text](#hover-effect-colored-text)
...
- [Animated Page](#animated-page)
- [Tabs](#tabs)
- [Beautiful Portfolio Design](#beautiful-portfolio-design)
- [Quiz Using HTML, CSS, JS](#quiz-using-html-css-js)
- [Website in 3D Design with Dora](#website-in-3d-design-with-dora)
- [Word Counter Project](#word-counter-project)
- [Profile Card Hover](#profile-card-hover)
- [Gradient Generator Project](#gradient-generator-project)
- [Shimmer Effect](#shimmer-effect)
- [Multiselect Dropdown](#multiselect-dropdown)
- [Input Label Animation](#input-label-animation)
- [Responsive Grid Layout](#responsive-grid-layout)
- [Hovering Glowing and Change Text](#hovering-glowing-and-change-text)
- [Footer Animated Background](#footer-animated-background)
- [Animated Menu](#animated-menu)
- [Menu with Names Animated](#menu-with-names-animated)
- [OTP Interface](#otp-interface)
- [Frontend APIs to Try Out](#frontend-apis-to-try-out)
- [Horizontal Loading Animation](#horizontal-loading-animation)
- [Website Portfolio](#website-portfolio)
- [Loaders and Spinners](#loaders-and-spinners)
- [Analog Clock](#analog-clock)
- [Frontend Tools](#frontend-tools)
- [Scroll Effect Top Navbar](#scroll-effect-top-navbar)
- [Notification as Title on the Bar](#notification-as-title-on-the-bar)
- [Navigation Bar for Account](#navigation-bar-for-account)
- [Hover Menu Underline Effect](#hover-menu-underline-effect)
- [Boxy Preloaders](#boxy-preloaders)
- [Calculator App](#calculator-app)
- [3D Profile Card](#3d-profile-card)
- [Upload Button](#upload-button)
- [Toast Notification](#toast-notification)
- [Unsubscribe Button](#unsubscribe-button)
- [Snackbar Animation](#snackbar-animation)
- [Password Input](#password-input)
- [Custom Cursor](#custom-cursor)
- [Login Page](#login-page)
- [Microsoft Home Page](#microsoft-home-page)
- [9 Dots Menu](#9-dots-menu)
- [Avatars List](#avatars-list)
- [Loading Animation Button](#loading-animation-button)
- [Magic Cursor Dust](#magic-cursor-dust)
- [Expandable Sidebars](#expandable-sidebars)
- [Hacker Login UI](#hacker-login-ui)
- [HTML CSS Loader](#html-css-loader)
- [Table Design](#table-design)
- [Animated Curved Sidebar](#animated-curved-sidebar)
- [Sliding Tab Animation](#sliding-tab-animation)
- [Grid Template for Entire Page](#grid-template-for-entire-page)
- [OTP Verification](#otp-verification)
- [Hover Effect Animation Card](#hover-effect-animation-card)
- [Login Sign-Up Form](#login-sign-up-form)
- [Sidenav Bar](#sidenav-bar)
- [CAPTCHA Code](#captcha-code)
- [Countdown Timer Code](#countdown-timer-code)
- [Profile Card Responsive](#profile-card-responsive)
- [Sidenav](#sidenav)
